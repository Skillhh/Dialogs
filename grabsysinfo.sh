...
# grabsysinfo.sh - A simple menu driven shell script to get 
# information abot your linux server / desktop
# Author: Vivek Gite
# Date: 12/Sep/2007
...
function host_info(){
	...
	write_header " Hostaname and DNS information "
	echo "Hostanem : $(hostname -s)"
...
# display a lust of receltly logged in users
function user_info(){
	local cmd="$1"
	case "$cmd" in
...
# Display used free and free memory info
function mem_info(){
